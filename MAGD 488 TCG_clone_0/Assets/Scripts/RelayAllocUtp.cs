...
public class RelayAllocUtp : MonoBehaviour
{
    ...
    async void Start()
    {
        mc = GameObject.FindObjectOfType<MythosClient>();
    ...
    public void OnJoin(string code) 
    {
        ...
        StartCoroutine(ClientBindAndConnect(code));
    }
    ...
    public IEnumerator StartServerAndJoin() 
    {
